...
import (
	...
	v2beta2 "k8s.io/code-generator/examples/upstream/listers/autoscaling/v2beta2"
)
...
type HorizontalPodAutoscalerClusterInformer interface {
	...
	Lister() v2beta2.HorizontalPodAutoscalerClusterLister
...
func NewHorizontalPodAutoscalerClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *horizontalPodAutoscalerClusterInformer) Lister() v2beta2.HorizontalPodAutoscalerClusterLister {
	return v2beta2.NewHorizontalPodAutoscalerClusterLister(f.Informer().GetIndexer())
}

...
import (
	...
	v1 "k8s.io/code-generator/examples/upstream/listers/autoscaling/v1"
)
...
type HorizontalPodAutoscalerClusterInformer interface {
	...
	Lister() v1.HorizontalPodAutoscalerClusterLister
...
func (f *horizontalPodAutoscalerClusterInformer) Lister() v1.HorizontalPodAutoscalerClusterLister {
	return v1.NewHorizontalPodAutoscalerClusterLister(f.Informer().GetIndexer())
}

...
type HorizontalPodAutoscalerClusterInformer interface {
	...
	Lister() v2beta1.HorizontalPodAutoscalerClusterLister
...
func (f *horizontalPodAutoscalerClusterInformer) Lister() v2beta1.HorizontalPodAutoscalerClusterLister {
	return v2beta1.NewHorizontalPodAutoscalerClusterLister(f.Informer().GetIndexer())
}

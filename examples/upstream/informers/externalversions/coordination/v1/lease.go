...
func NewLeaseClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *leaseClusterInformer) Lister() v1.LeaseClusterLister {
	return v1.NewLeaseClusterLister(f.Informer().GetIndexer())
}

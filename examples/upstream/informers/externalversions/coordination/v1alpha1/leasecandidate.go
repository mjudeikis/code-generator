...
type LeaseCandidateClusterInformer interface {
	...
	Lister() v1alpha1.LeaseCandidateClusterLister
...
func NewLeaseCandidateClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredLeaseCandidateInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *leaseCandidateClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&coordinationv1alpha1.LeaseCandidate{}, f.defaultInformer)
}

func (f *leaseCandidateClusterInformer) Lister() v1alpha1.LeaseCandidateClusterLister {
	return v1alpha1.NewLeaseCandidateClusterLister(f.Informer().GetIndexer())
}

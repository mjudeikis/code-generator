...
type ClusterTrustBundleClusterInformer interface {
	...
	Lister() v1alpha1.ClusterTrustBundleClusterLister
...
func (f *clusterTrustBundleClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&certificatesv1alpha1.ClusterTrustBundle{}, f.defaultInformer)
}

func (f *clusterTrustBundleClusterInformer) Lister() v1alpha1.ClusterTrustBundleClusterLister {
	return v1alpha1.NewClusterTrustBundleClusterLister(f.Informer().GetIndexer())
}

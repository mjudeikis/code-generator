...
type StatefulSetClusterInformer interface {
	...
	Lister() v1beta1.StatefulSetClusterLister
...
func (f *statefulSetClusterInformer) Lister() v1beta1.StatefulSetClusterLister {
	return v1beta1.NewStatefulSetClusterLister(f.Informer().GetIndexer())
}

...
type DaemonSetClusterInformer interface {
	...
	Lister() v1beta2.DaemonSetClusterLister
...
func (f *daemonSetClusterInformer) Lister() v1beta2.DaemonSetClusterLister {
	return v1beta2.NewDaemonSetClusterLister(f.Informer().GetIndexer())
}

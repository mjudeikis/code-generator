...
type ControllerRevisionClusterInformer interface {
	...
	Lister() v1beta2.ControllerRevisionClusterLister
...
func (f *controllerRevisionClusterInformer) Lister() v1beta2.ControllerRevisionClusterLister {
	return v1beta2.NewControllerRevisionClusterLister(f.Informer().GetIndexer())
}

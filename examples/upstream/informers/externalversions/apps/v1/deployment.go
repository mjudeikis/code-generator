...
type DeploymentClusterInformer interface {
	...
	Lister() v1.DeploymentClusterLister
...
func (f *deploymentClusterInformer) Lister() v1.DeploymentClusterLister {
	return v1.NewDeploymentClusterLister(f.Informer().GetIndexer())
}

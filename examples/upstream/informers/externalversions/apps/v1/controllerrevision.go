...
type ControllerRevisionClusterInformer interface {
	...
	Lister() v1.ControllerRevisionClusterLister
...
func (f *controllerRevisionClusterInformer) Lister() v1.ControllerRevisionClusterLister {
	return v1.NewControllerRevisionClusterLister(f.Informer().GetIndexer())
}

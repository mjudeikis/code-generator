...
type ReplicaSetClusterInformer interface {
	...
	Lister() v1.ReplicaSetClusterLister
...
func (f *replicaSetClusterInformer) Lister() v1.ReplicaSetClusterLister {
	return v1.NewReplicaSetClusterLister(f.Informer().GetIndexer())
}

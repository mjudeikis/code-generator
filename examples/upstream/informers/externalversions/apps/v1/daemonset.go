...
type DaemonSetClusterInformer interface {
	...
	Lister() v1.DaemonSetClusterLister
...
func (f *daemonSetClusterInformer) Lister() v1.DaemonSetClusterLister {
	return v1.NewDaemonSetClusterLister(f.Informer().GetIndexer())
}

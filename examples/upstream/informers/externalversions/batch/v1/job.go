...
import (
	...
	v1 "k8s.io/code-generator/examples/upstream/listers/batch/v1"
)
...
func NewJobClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *jobClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *jobClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&batchv1.Job{}, f.defaultInformer)
}

func (f *jobClusterInformer) Lister() v1.JobClusterLister {
	return v1.NewJobClusterLister(f.Informer().GetIndexer())
}

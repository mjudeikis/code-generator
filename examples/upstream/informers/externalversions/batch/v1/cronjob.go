...
type CronJobClusterInformer interface {
	...
	Lister() v1.CronJobClusterLister
...
func NewCronJobClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *cronJobClusterInformer) Lister() v1.CronJobClusterLister {
	return v1.NewCronJobClusterLister(f.Informer().GetIndexer())
}

...
type CSIDriverClusterInformer interface {
	...
	Lister() v1.CSIDriverClusterLister
...
func (f *cSIDriverClusterInformer) Lister() v1.CSIDriverClusterLister {
	return v1.NewCSIDriverClusterLister(f.Informer().GetIndexer())
}

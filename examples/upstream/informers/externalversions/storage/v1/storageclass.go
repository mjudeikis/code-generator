...
type StorageClassClusterInformer interface {
	...
	Lister() v1.StorageClassClusterLister
...
func (f *storageClassClusterInformer) Lister() v1.StorageClassClusterLister {
	return v1.NewStorageClassClusterLister(f.Informer().GetIndexer())
}

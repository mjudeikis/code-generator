...
type CSIStorageCapacityClusterInformer interface {
	...
	Lister() v1.CSIStorageCapacityClusterLister
...
func (f *cSIStorageCapacityClusterInformer) Lister() v1.CSIStorageCapacityClusterLister {
	return v1.NewCSIStorageCapacityClusterLister(f.Informer().GetIndexer())
}

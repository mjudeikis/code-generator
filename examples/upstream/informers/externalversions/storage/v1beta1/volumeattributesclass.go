...
type VolumeAttributesClassClusterInformer interface {
	...
	Lister() v1beta1.VolumeAttributesClassClusterLister
...
func (f *volumeAttributesClassClusterInformer) Lister() v1beta1.VolumeAttributesClassClusterLister {
	return v1beta1.NewVolumeAttributesClassClusterLister(f.Informer().GetIndexer())
}

...
type CSIStorageCapacityClusterInformer interface {
	...
	Lister() v1beta1.CSIStorageCapacityClusterLister
...
func (f *cSIStorageCapacityClusterInformer) Lister() v1beta1.CSIStorageCapacityClusterLister {
	return v1beta1.NewCSIStorageCapacityClusterLister(f.Informer().GetIndexer())
}

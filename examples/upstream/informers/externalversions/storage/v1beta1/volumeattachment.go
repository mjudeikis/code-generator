...
type VolumeAttachmentClusterInformer interface {
	...
	Lister() v1beta1.VolumeAttachmentClusterLister
	Cluster(logicalcluster.Name) upstreamstoragev1beta1informers.VolumeAttachmentInformer
}
...
func (f *volumeAttachmentClusterInformer) Lister() v1beta1.VolumeAttachmentClusterLister {
	return v1beta1.NewVolumeAttachmentClusterLister(f.Informer().GetIndexer())
}

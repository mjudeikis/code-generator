...
type CSINodeClusterInformer interface {
	...
	Lister() v1beta1.CSINodeClusterLister
...
func (f *cSINodeClusterInformer) Lister() v1beta1.CSINodeClusterLister {
	return v1beta1.NewCSINodeClusterLister(f.Informer().GetIndexer())
}

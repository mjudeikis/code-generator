...
type StorageClassClusterInformer interface {
	...
	Lister() v1beta1.StorageClassClusterLister
...
func (f *storageClassClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1beta1.StorageClass{}, f.defaultInformer)
}

func (f *storageClassClusterInformer) Lister() v1beta1.StorageClassClusterLister {
	return v1beta1.NewStorageClassClusterLister(f.Informer().GetIndexer())
}

...
type VolumeAttachmentClusterInformer interface {
	...
	Lister() v1alpha1.VolumeAttachmentClusterLister
...
func (f *volumeAttachmentClusterInformer) Lister() v1alpha1.VolumeAttachmentClusterLister {
	return v1alpha1.NewVolumeAttachmentClusterLister(f.Informer().GetIndexer())
}

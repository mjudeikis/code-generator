...
type VolumeAttributesClassClusterInformer interface {
	...
	Lister() v1alpha1.VolumeAttributesClassClusterLister
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredVolumeAttributesClassInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *volumeAttributesClassClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagev1alpha1.VolumeAttributesClass{}, f.defaultInformer)
}

func (f *volumeAttributesClassClusterInformer) Lister() v1alpha1.VolumeAttributesClassClusterLister {
	return v1alpha1.NewVolumeAttributesClassClusterLister(f.Informer().GetIndexer())
}

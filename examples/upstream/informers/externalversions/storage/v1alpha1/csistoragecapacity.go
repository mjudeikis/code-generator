...
type CSIStorageCapacityClusterInformer interface {
	...
	Lister() v1alpha1.CSIStorageCapacityClusterLister
...
func NewCSIStorageCapacityClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredCSIStorageCapacityInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *cSIStorageCapacityClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *cSIStorageCapacityClusterInformer) Lister() v1alpha1.CSIStorageCapacityClusterLister {
	return v1alpha1.NewCSIStorageCapacityClusterLister(f.Informer().GetIndexer())
}

...
type ResourceSliceClusterInformer interface {
	...
	Lister() v1alpha3.ResourceSliceClusterLister
...
func NewResourceSliceClusterInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *resourceSliceClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *resourceSliceClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1alpha3.ResourceSlice{}, f.defaultInformer)
}

func (f *resourceSliceClusterInformer) Lister() v1alpha3.ResourceSliceClusterLister {
	return v1alpha3.NewResourceSliceClusterLister(f.Informer().GetIndexer())
}

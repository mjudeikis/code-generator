...
type ResourceClaimTemplateClusterInformer interface {
	...
	Lister() v1alpha3.ResourceClaimTemplateClusterLister
...
func NewResourceClaimTemplateClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *resourceClaimTemplateClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1alpha3.ResourceClaimTemplate{}, f.defaultInformer)
}

func (f *resourceClaimTemplateClusterInformer) Lister() v1alpha3.ResourceClaimTemplateClusterLister {
	return v1alpha3.NewResourceClaimTemplateClusterLister(f.Informer().GetIndexer())
}

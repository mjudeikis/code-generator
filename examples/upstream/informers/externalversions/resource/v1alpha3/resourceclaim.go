...
type ResourceClaimClusterInformer interface {
	...
	Lister() v1alpha3.ResourceClaimClusterLister
...
func NewResourceClaimClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *resourceClaimClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1alpha3.ResourceClaim{}, f.defaultInformer)
}

func (f *resourceClaimClusterInformer) Lister() v1alpha3.ResourceClaimClusterLister {
	return v1alpha3.NewResourceClaimClusterLister(f.Informer().GetIndexer())
}

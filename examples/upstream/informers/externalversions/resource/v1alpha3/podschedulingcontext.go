...
type PodSchedulingContextClusterInformer interface {
	...
	Lister() v1alpha3.PodSchedulingContextClusterLister
...
func NewPodSchedulingContextClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredPodSchedulingContextInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *podSchedulingContextClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *podSchedulingContextClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resourcev1alpha3.PodSchedulingContext{}, f.defaultInformer)
}

func (f *podSchedulingContextClusterInformer) Lister() v1alpha3.PodSchedulingContextClusterLister {
	return v1alpha3.NewPodSchedulingContextClusterLister(f.Informer().GetIndexer())
}

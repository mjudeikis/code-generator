...
type ValidatingAdmissionPolicyBindingClusterInformer interface {
	...
	Lister() v1beta1.ValidatingAdmissionPolicyBindingClusterLister
...
func (f *validatingAdmissionPolicyBindingClusterInformer) Lister() v1beta1.ValidatingAdmissionPolicyBindingClusterLister {
	return v1beta1.NewValidatingAdmissionPolicyBindingClusterLister(f.Informer().GetIndexer())
}

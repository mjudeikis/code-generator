...
type MutatingWebhookConfigurationClusterInformer interface {
	...
	Lister() v1beta1.MutatingWebhookConfigurationClusterLister
...
func (f *mutatingWebhookConfigurationClusterInformer) Lister() v1beta1.MutatingWebhookConfigurationClusterLister {

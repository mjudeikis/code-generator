...
type ValidatingWebhookConfigurationClusterInformer interface {
	...
	Lister() v1beta1.ValidatingWebhookConfigurationClusterLister
...
func (f *validatingWebhookConfigurationClusterInformer) Lister() v1beta1.ValidatingWebhookConfigurationClusterLister {
	return v1beta1.NewValidatingWebhookConfigurationClusterLister(f.Informer().GetIndexer())
}

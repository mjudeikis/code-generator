...
type ValidatingAdmissionPolicyClusterInformer interface {
	...
	Lister() v1beta1.ValidatingAdmissionPolicyClusterLister
	Cluster(logicalcluster.Name) upstreamadmissionregistrationv1beta1informers.ValidatingAdmissionPolicyInformer
}
...
func (f *validatingAdmissionPolicyClusterInformer) Lister() v1beta1.ValidatingAdmissionPolicyClusterLister {
	return v1beta1.NewValidatingAdmissionPolicyClusterLister(f.Informer().GetIndexer())
}

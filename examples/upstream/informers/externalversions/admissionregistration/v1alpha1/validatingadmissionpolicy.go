...
type ValidatingAdmissionPolicyClusterInformer interface {
	...
	Lister() v1alpha1.ValidatingAdmissionPolicyClusterLister
	Cluster(logicalcluster.Name) upstreamadmissionregistrationv1alpha1informers.ValidatingAdmissionPolicyInformer
}
...
func (f *validatingAdmissionPolicyClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&admissionregistrationv1alpha1.ValidatingAdmissionPolicy{}, f.defaultInformer)
}

func (f *validatingAdmissionPolicyClusterInformer) Lister() v1alpha1.ValidatingAdmissionPolicyClusterLister {
	return v1alpha1.NewValidatingAdmissionPolicyClusterLister(f.Informer().GetIndexer())
}

...
type ValidatingAdmissionPolicyBindingClusterInformer interface {
	...
	Lister() v1alpha1.ValidatingAdmissionPolicyBindingClusterLister
...
func (f *validatingAdmissionPolicyBindingClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&admissionregistrationv1alpha1.ValidatingAdmissionPolicyBinding{}, f.defaultInformer)
}

func (f *validatingAdmissionPolicyBindingClusterInformer) Lister() v1alpha1.ValidatingAdmissionPolicyBindingClusterLister {
	return v1alpha1.NewValidatingAdmissionPolicyBindingClusterLister(f.Informer().GetIndexer())
}

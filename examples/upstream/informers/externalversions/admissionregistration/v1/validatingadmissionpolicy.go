...
type ValidatingAdmissionPolicyClusterInformer interface {
	...
	Lister() v1.ValidatingAdmissionPolicyClusterLister
...
func (f *validatingAdmissionPolicyClusterInformer) Lister() v1.ValidatingAdmissionPolicyClusterLister {
	return v1.NewValidatingAdmissionPolicyClusterLister(f.Informer().GetIndexer())
}

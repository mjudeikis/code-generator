...
type MutatingWebhookConfigurationClusterInformer interface {
	...
	Lister() v1.MutatingWebhookConfigurationClusterLister
...
func (f *mutatingWebhookConfigurationClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&admissionregistrationv1.MutatingWebhookConfiguration{}, f.defaultInformer)
}

func (f *mutatingWebhookConfigurationClusterInformer) Lister() v1.MutatingWebhookConfigurationClusterLister {
	return v1.NewMutatingWebhookConfigurationClusterLister(f.Informer().GetIndexer())
}

...
type ValidatingAdmissionPolicyBindingClusterInformer interface {
	...
	Lister() v1.ValidatingAdmissionPolicyBindingClusterLister
...
func (f *validatingAdmissionPolicyBindingClusterInformer) Lister() v1.ValidatingAdmissionPolicyBindingClusterLister {
	return v1.NewValidatingAdmissionPolicyBindingClusterLister(f.Informer().GetIndexer())
}

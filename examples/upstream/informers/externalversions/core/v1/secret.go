...
func NewSecretClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *secretClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *secretClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1.Secret{}, f.defaultInformer)
}

func (f *secretClusterInformer) Lister() v1.SecretClusterLister {
	return v1.NewSecretClusterLister(f.Informer().GetIndexer())
}

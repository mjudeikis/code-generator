...
type EndpointsClusterInformer interface {
	...
	Lister() v1.EndpointsClusterLister
...
func NewEndpointsClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *endpointsClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1.Endpoints{}, f.defaultInformer)
}

func (f *endpointsClusterInformer) Lister() v1.EndpointsClusterLister {
	return v1.NewEndpointsClusterLister(f.Informer().GetIndexer())
}

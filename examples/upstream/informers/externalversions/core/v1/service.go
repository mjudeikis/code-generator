...
type ServiceClusterInformer interface {
	...
	Lister() v1.ServiceClusterLister
...
func NewServiceClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *serviceClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1.Service{}, f.defaultInformer)
}

func (f *serviceClusterInformer) Lister() v1.ServiceClusterLister {
	return v1.NewServiceClusterLister(f.Informer().GetIndexer())
}

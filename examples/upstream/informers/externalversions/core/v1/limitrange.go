...
type LimitRangeClusterInformer interface {
	...
	Lister() v1.LimitRangeClusterLister
...
func NewLimitRangeClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *limitRangeClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *limitRangeClusterInformer) Lister() v1.LimitRangeClusterLister {
	return v1.NewLimitRangeClusterLister(f.Informer().GetIndexer())
}

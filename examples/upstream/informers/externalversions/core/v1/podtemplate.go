...
type PodTemplateClusterInformer interface {
	...
	Lister() v1.PodTemplateClusterLister
...
func NewPodTemplateClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *podTemplateClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *podTemplateClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1.PodTemplate{}, f.defaultInformer)
}

func (f *podTemplateClusterInformer) Lister() v1.PodTemplateClusterLister {
	return v1.NewPodTemplateClusterLister(f.Informer().GetIndexer())
}

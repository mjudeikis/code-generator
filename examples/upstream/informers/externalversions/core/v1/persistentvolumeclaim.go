...
type PersistentVolumeClaimClusterInformer interface {
	...
	Lister() v1.PersistentVolumeClaimClusterLister
...
func NewPersistentVolumeClaimClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *persistentVolumeClaimClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *persistentVolumeClaimClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1.PersistentVolumeClaim{}, f.defaultInformer)
}

func (f *persistentVolumeClaimClusterInformer) Lister() v1.PersistentVolumeClaimClusterLister {
	return v1.NewPersistentVolumeClaimClusterLister(f.Informer().GetIndexer())
}

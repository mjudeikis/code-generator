...
type ConfigMapClusterInformer interface {
	...
	Lister() v1.ConfigMapClusterLister
...
func NewConfigMapClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *configMapClusterInformer) Lister() v1.ConfigMapClusterLister {
	return v1.NewConfigMapClusterLister(f.Informer().GetIndexer())
}

...
type NamespaceClusterInformer interface {
	...
	Lister() v1.NamespaceClusterLister
...
func NewNamespaceClusterInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *namespaceClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *namespaceClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1.Namespace{}, f.defaultInformer)
}

func (f *namespaceClusterInformer) Lister() v1.NamespaceClusterLister {
	return v1.NewNamespaceClusterLister(f.Informer().GetIndexer())
}

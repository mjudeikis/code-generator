...
type ReplicationControllerClusterInformer interface {
	...
	Lister() v1.ReplicationControllerClusterLister
...
func NewReplicationControllerClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *replicationControllerClusterInformer) Lister() v1.ReplicationControllerClusterLister {
	return v1.NewReplicationControllerClusterLister(f.Informer().GetIndexer())
}

...
type ResourceQuotaClusterInformer interface {
	...
	Lister() v1.ResourceQuotaClusterLister
...
func NewResourceQuotaClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *resourceQuotaClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1.ResourceQuota{}, f.defaultInformer)
}

func (f *resourceQuotaClusterInformer) Lister() v1.ResourceQuotaClusterLister {
	return v1.NewResourceQuotaClusterLister(f.Informer().GetIndexer())
}

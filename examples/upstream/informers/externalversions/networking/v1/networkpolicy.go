...
type NetworkPolicyClusterInformer interface {
	...
	Lister() v1.NetworkPolicyClusterLister
...
func (f *networkPolicyClusterInformer) Lister() v1.NetworkPolicyClusterLister {
	return v1.NewNetworkPolicyClusterLister(f.Informer().GetIndexer())
}

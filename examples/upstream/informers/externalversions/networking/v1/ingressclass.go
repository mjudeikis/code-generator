...
type IngressClassClusterInformer interface {
	...
	Lister() v1.IngressClassClusterLister
	Cluster(logicalcluster.Name) upstreamnetworkingv1informers.IngressClassInformer
}
...
func NewIngressClassClusterInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *ingressClassClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *ingressClassClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1.IngressClass{}, f.defaultInformer)
}

func (f *ingressClassClusterInformer) Lister() v1.IngressClassClusterLister {

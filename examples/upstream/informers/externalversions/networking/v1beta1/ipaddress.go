...
type IPAddressClusterInformer interface {
	...
	Lister() v1beta1.IPAddressClusterLister
...
func (f *iPAddressClusterInformer) Lister() v1beta1.IPAddressClusterLister {
	return v1beta1.NewIPAddressClusterLister(f.Informer().GetIndexer())
}

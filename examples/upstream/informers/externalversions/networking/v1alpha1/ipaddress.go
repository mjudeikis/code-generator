...
type IPAddressClusterInformer interface {
	...
	Lister() v1alpha1.IPAddressClusterLister
...
func (f *iPAddressClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingv1alpha1.IPAddress{}, f.defaultInformer)
}

func (f *iPAddressClusterInformer) Lister() v1alpha1.IPAddressClusterLister {
	return v1alpha1.NewIPAddressClusterLister(f.Informer().GetIndexer())
}

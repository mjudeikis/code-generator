...
type ServiceCIDRClusterInformer interface {
	...
	Lister() v1alpha1.ServiceCIDRClusterLister
...
func (f *serviceCIDRClusterInformer) Lister() v1alpha1.ServiceCIDRClusterLister {
	return v1alpha1.NewServiceCIDRClusterLister(f.Informer().GetIndexer())
}

...
type PriorityClassClusterInformer interface {
	...
	Lister() v1.PriorityClassClusterLister
...
func (f *priorityClassClusterInformer) Lister() v1.PriorityClassClusterLister {
	return v1.NewPriorityClassClusterLister(f.Informer().GetIndexer())
}

...
type PriorityClassClusterInformer interface {
	...
	Lister() v1alpha1.PriorityClassClusterLister
...
func (f *priorityClassClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schedulingv1alpha1.PriorityClass{}, f.defaultInformer)
}

func (f *priorityClassClusterInformer) Lister() v1alpha1.PriorityClassClusterLister {
	return v1alpha1.NewPriorityClassClusterLister(f.Informer().GetIndexer())
}

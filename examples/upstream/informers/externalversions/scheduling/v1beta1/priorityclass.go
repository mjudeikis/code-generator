...
type PriorityClassClusterInformer interface {
	...
	Lister() v1beta1.PriorityClassClusterLister
...
func (f *priorityClassClusterInformer) Lister() v1beta1.PriorityClassClusterLister {
	return v1beta1.NewPriorityClassClusterLister(f.Informer().GetIndexer())
}

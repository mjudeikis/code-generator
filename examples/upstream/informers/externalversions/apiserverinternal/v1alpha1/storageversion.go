...
import (
	...
	upstreaminternalv1alpha1informers "k8s.io/client-go/informers/internal/v1alpha1"
...
type StorageVersionClusterInformer interface {
	...
	Lister() v1alpha1.StorageVersionClusterLister
...
func (f *storageVersionClusterInformer) Lister() v1alpha1.StorageVersionClusterLister {

...
type StorageVersionMigrationClusterInformer interface {
	...
	Lister() v1alpha1.StorageVersionMigrationClusterLister
...
func (f *storageVersionMigrationClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagemigrationv1alpha1.StorageVersionMigration{}, f.defaultInformer)
}

func (f *storageVersionMigrationClusterInformer) Lister() v1alpha1.StorageVersionMigrationClusterLister {
	return v1alpha1.NewStorageVersionMigrationClusterLister(f.Informer().GetIndexer())
}

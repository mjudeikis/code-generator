...
type EndpointSliceClusterInformer interface {
	...
	Lister() v1beta1.EndpointSliceClusterLister
...
func NewEndpointSliceClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *endpointSliceClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&discoveryv1beta1.EndpointSlice{}, f.defaultInformer)
}

func (f *endpointSliceClusterInformer) Lister() v1beta1.EndpointSliceClusterLister {
	return v1beta1.NewEndpointSliceClusterLister(f.Informer().GetIndexer())
}

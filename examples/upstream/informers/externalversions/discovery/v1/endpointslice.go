...
type EndpointSliceClusterInformer interface {
	...
	Lister() v1.EndpointSliceClusterLister
...
func (f *endpointSliceClusterInformer) Lister() v1.EndpointSliceClusterLister {
	return v1.NewEndpointSliceClusterLister(f.Informer().GetIndexer())
}

...
type FlowSchemaClusterInformer interface {
	...
	Lister() v1beta2.FlowSchemaClusterLister
...
func (f *flowSchemaClusterInformer) Lister() v1beta2.FlowSchemaClusterLister {
	return v1beta2.NewFlowSchemaClusterLister(f.Informer().GetIndexer())
}

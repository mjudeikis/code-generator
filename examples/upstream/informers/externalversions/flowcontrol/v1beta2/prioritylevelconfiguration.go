...
type PriorityLevelConfigurationClusterInformer interface {
	...
	Lister() v1beta2.PriorityLevelConfigurationClusterLister
...
func (f *priorityLevelConfigurationClusterInformer) Lister() v1beta2.PriorityLevelConfigurationClusterLister {
	return v1beta2.NewPriorityLevelConfigurationClusterLister(f.Informer().GetIndexer())
}

...
type FlowSchemaClusterInformer interface {
	...
	Lister() v1beta1.FlowSchemaClusterLister
...
func (f *flowSchemaClusterInformer) Lister() v1beta1.FlowSchemaClusterLister {
	return v1beta1.NewFlowSchemaClusterLister(f.Informer().GetIndexer())
}

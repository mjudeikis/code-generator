...
type PriorityLevelConfigurationClusterInformer interface {
	...
	Lister() v1beta1.PriorityLevelConfigurationClusterLister
...
func (f *priorityLevelConfigurationClusterInformer) Lister() v1beta1.PriorityLevelConfigurationClusterLister {
	return v1beta1.NewPriorityLevelConfigurationClusterLister(f.Informer().GetIndexer())
}

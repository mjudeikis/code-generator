...
import (
	...
	upstreamflowcontrolv1informers "k8s.io/client-go/informers/flowcontrol/v1"
...
type PriorityLevelConfigurationClusterInformer interface {
	...
	Lister() v1.PriorityLevelConfigurationClusterLister
	Cluster(logicalcluster.Name) upstreamflowcontrolv1informers.PriorityLevelConfigurationInformer
}
...
func (f *priorityLevelConfigurationClusterInformer) Lister() v1.PriorityLevelConfigurationClusterLister {
	return v1.NewPriorityLevelConfigurationClusterLister(f.Informer().GetIndexer())
}

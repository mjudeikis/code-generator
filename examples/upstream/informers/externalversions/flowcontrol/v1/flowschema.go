...
type FlowSchemaClusterInformer interface {
	...
	Lister() v1.FlowSchemaClusterLister
	Cluster(logicalcluster.Name) upstreamflowcontrolv1informers.FlowSchemaInformer
}
...
func (f *flowSchemaClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&flowcontrolv1.FlowSchema{}, f.defaultInformer)
}

func (f *flowSchemaClusterInformer) Lister() v1.FlowSchemaClusterLister {
	return v1.NewFlowSchemaClusterLister(f.Informer().GetIndexer())
}

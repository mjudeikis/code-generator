...
type FlowSchemaClusterInformer interface {
	...
	Lister() v1beta3.FlowSchemaClusterLister
...
func (f *flowSchemaClusterInformer) Lister() v1beta3.FlowSchemaClusterLister {
	return v1beta3.NewFlowSchemaClusterLister(f.Informer().GetIndexer())
}

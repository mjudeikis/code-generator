...
type PriorityLevelConfigurationClusterInformer interface {
	...
	Lister() v1beta3.PriorityLevelConfigurationClusterLister
...
func (f *priorityLevelConfigurationClusterInformer) Lister() v1beta3.PriorityLevelConfigurationClusterLister {
	return v1beta3.NewPriorityLevelConfigurationClusterLister(f.Informer().GetIndexer())
}

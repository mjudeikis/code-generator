...
type ClusterRoleClusterInformer interface {
	...
	Lister() v1beta1.ClusterRoleClusterLister
...
func (f *clusterRoleClusterInformer) Lister() v1beta1.ClusterRoleClusterLister {
	return v1beta1.NewClusterRoleClusterLister(f.Informer().GetIndexer())
}

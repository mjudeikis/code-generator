...
type RoleBindingClusterInformer interface {
	...
	Lister() v1beta1.RoleBindingClusterLister
...
func (f *roleBindingClusterInformer) Lister() v1beta1.RoleBindingClusterLister {
	return v1beta1.NewRoleBindingClusterLister(f.Informer().GetIndexer())
}

...
type ClusterRoleBindingClusterInformer interface {
	...
	Lister() v1beta1.ClusterRoleBindingClusterLister
...
func (f *clusterRoleBindingClusterInformer) Lister() v1beta1.ClusterRoleBindingClusterLister {
	return v1beta1.NewClusterRoleBindingClusterLister(f.Informer().GetIndexer())
}

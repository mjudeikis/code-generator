...
type RoleClusterInformer interface {
	...
	Lister() v1beta1.RoleClusterLister
...
func NewRoleClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *roleClusterInformer) Lister() v1beta1.RoleClusterLister {
	return v1beta1.NewRoleClusterLister(f.Informer().GetIndexer())
}

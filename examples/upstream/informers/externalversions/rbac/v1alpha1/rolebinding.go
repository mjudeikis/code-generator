...
type RoleBindingClusterInformer interface {
	...
	Lister() v1alpha1.RoleBindingClusterLister
...
func NewRoleBindingClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *roleBindingClusterInformer) Lister() v1alpha1.RoleBindingClusterLister {
	return v1alpha1.NewRoleBindingClusterLister(f.Informer().GetIndexer())
}

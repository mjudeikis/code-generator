...
type ClusterRoleBindingClusterInformer interface {
	...
	Lister() v1alpha1.ClusterRoleBindingClusterLister
...
func (f *clusterRoleBindingClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rbacv1alpha1.ClusterRoleBinding{}, f.defaultInformer)
}

func (f *clusterRoleBindingClusterInformer) Lister() v1alpha1.ClusterRoleBindingClusterLister {
	return v1alpha1.NewClusterRoleBindingClusterLister(f.Informer().GetIndexer())
}

...
type RoleBindingClusterInformer interface {
	...
	Lister() v1.RoleBindingClusterLister
...
func (f *roleBindingClusterInformer) Lister() v1.RoleBindingClusterLister {
	return v1.NewRoleBindingClusterLister(f.Informer().GetIndexer())
}

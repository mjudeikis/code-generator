...
type ClusterRoleBindingClusterInformer interface {
	...
	Lister() v1.ClusterRoleBindingClusterLister
...
func (f *clusterRoleBindingClusterInformer) Lister() v1.ClusterRoleBindingClusterLister {
	return v1.NewClusterRoleBindingClusterLister(f.Informer().GetIndexer())
}

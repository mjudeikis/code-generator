...
type ClusterRoleClusterInformer interface {
	...
	Lister() v1.ClusterRoleClusterLister
	Cluster(logicalcluster.Name) upstreamrbacv1informers.ClusterRoleInformer
}
...
func (f *clusterRoleClusterInformer) Lister() v1.ClusterRoleClusterLister {
	return v1.NewClusterRoleClusterLister(f.Informer().GetIndexer())
}

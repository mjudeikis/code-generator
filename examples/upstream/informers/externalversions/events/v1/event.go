...
import (
	...
	upstreameventsv1informers "k8s.io/client-go/informers/events/v1"
...
type EventClusterInformer interface {
	...
	Lister() v1.EventClusterLister
	Cluster(logicalcluster.Name) upstreameventsv1informers.EventInformer
}
...
func NewEventClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *eventClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventsv1.Event{}, f.defaultInformer)
}

func (f *eventClusterInformer) Lister() v1.EventClusterLister {
	return v1.NewEventClusterLister(f.Informer().GetIndexer())
}

...
type EventClusterInformer interface {
	...
	Lister() v1beta1.EventClusterLister
...
func (f *eventClusterInformer) Lister() v1beta1.EventClusterLister {
	return v1beta1.NewEventClusterLister(f.Informer().GetIndexer())
}

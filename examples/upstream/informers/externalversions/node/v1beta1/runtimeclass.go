...
import (
	...
	v1beta1 "k8s.io/code-generator/examples/upstream/listers/node/v1beta1"
)
...
type RuntimeClassClusterInformer interface {
	...
	Lister() v1beta1.RuntimeClassClusterLister
...
func (f *runtimeClassClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nodev1beta1.RuntimeClass{}, f.defaultInformer)
}

func (f *runtimeClassClusterInformer) Lister() v1beta1.RuntimeClassClusterLister {
	return v1beta1.NewRuntimeClassClusterLister(f.Informer().GetIndexer())
}

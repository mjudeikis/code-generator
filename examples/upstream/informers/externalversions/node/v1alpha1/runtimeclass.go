...
type RuntimeClassClusterInformer interface {
	...
	Lister() v1alpha1.RuntimeClassClusterLister
...
func (f *runtimeClassClusterInformer) Lister() v1alpha1.RuntimeClassClusterLister {
	return v1alpha1.NewRuntimeClassClusterLister(f.Informer().GetIndexer())
}

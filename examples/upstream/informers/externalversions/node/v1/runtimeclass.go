...
type RuntimeClassClusterInformer interface {
	...
	Lister() v1.RuntimeClassClusterLister
...
func (f *runtimeClassClusterInformer) Lister() v1.RuntimeClassClusterLister {
	return v1.NewRuntimeClassClusterLister(f.Informer().GetIndexer())
}

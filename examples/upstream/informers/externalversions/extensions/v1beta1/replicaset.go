...
type ReplicaSetClusterInformer interface {
	...
	Lister() v1beta1.ReplicaSetClusterLister
...
func NewReplicaSetClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *replicaSetClusterInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *replicaSetClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensionsv1beta1.ReplicaSet{}, f.defaultInformer)
}

func (f *replicaSetClusterInformer) Lister() v1beta1.ReplicaSetClusterLister {
	return v1beta1.NewReplicaSetClusterLister(f.Informer().GetIndexer())
}

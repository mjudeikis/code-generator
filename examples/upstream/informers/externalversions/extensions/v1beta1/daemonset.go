...
type DaemonSetClusterInformer interface {
	...
	Lister() v1beta1.DaemonSetClusterLister
...
func NewDaemonSetClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *daemonSetClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensionsv1beta1.DaemonSet{}, f.defaultInformer)
}

func (f *daemonSetClusterInformer) Lister() v1beta1.DaemonSetClusterLister {

...
type NetworkPolicyClusterInformer interface {
	...
	Lister() v1beta1.NetworkPolicyClusterLister
...
func NewNetworkPolicyClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *networkPolicyClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensionsv1beta1.NetworkPolicy{}, f.defaultInformer)
}

func (f *networkPolicyClusterInformer) Lister() v1beta1.NetworkPolicyClusterLister {
	return v1beta1.NewNetworkPolicyClusterLister(f.Informer().GetIndexer())
}

...
type IngressClusterInformer interface {
	...
	Lister() v1beta1.IngressClusterLister
...
func NewIngressClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *ingressClusterInformer) Lister() v1beta1.IngressClusterLister {

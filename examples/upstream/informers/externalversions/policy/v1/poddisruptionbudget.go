...
type PodDisruptionBudgetClusterInformer interface {
	...
	Lister() v1.PodDisruptionBudgetClusterLister
...
func (f *podDisruptionBudgetClusterInformer) Lister() v1.PodDisruptionBudgetClusterLister {
	return v1.NewPodDisruptionBudgetClusterLister(f.Informer().GetIndexer())
}

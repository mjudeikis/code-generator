...
import (
	...
	v1beta1 "k8s.io/code-generator/examples/upstream/listers/policy/v1beta1"
)
...
type PodDisruptionBudgetClusterInformer interface {
	...
	Lister() v1beta1.PodDisruptionBudgetClusterLister
...
func NewPodDisruptionBudgetClusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
func (f *podDisruptionBudgetClusterInformer) Lister() v1beta1.PodDisruptionBudgetClusterLister {

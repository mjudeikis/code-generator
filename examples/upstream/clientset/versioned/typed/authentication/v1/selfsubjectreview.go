...
import (
	...
	authenticationv1client "k8s.io/client-go/kuberentes/typed/authentication/v1"
...
type SelfSubjectReviewClusterInterface interface {
	Cluster(logicalcluster.Path) authenticationv1client.SelfSubjectReviewInterface

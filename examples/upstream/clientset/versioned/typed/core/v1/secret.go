...
type SecretsClusterGetter interface {
	Secrets(namespace string) SecretClusterInterface
}

// SecretInterface has methods to work with Secret resources.
type SecretClusterInterface interface {
	Cluster(logicalcluster.Path) corev1client.SecretInterface

	List(ctx context.Context, opts v1.ListOptions) (*corev1.SecretList, error)

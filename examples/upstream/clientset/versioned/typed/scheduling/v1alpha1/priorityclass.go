...
import (
	...
	schedulingv1alpha1client "k8s.io/client-go/kuberentes/typed/scheduling/v1alpha1"
	schedulingv1alpha1 "k8s.io/code-generator/examples/upstream/applyconfiguration/scheduling/v1alpha1"

...
import (
	...
	autoscalingv1client "k8s.io/client-go/kuberentes/typed/autoscaling/v1"
...
type HorizontalPodAutoscalerClusterInterface interface {
	Cluster(logicalcluster.Path) autoscalingv1client.HorizontalPodAutoscalerInterface

	List(ctx context.Context, opts v1.ListOptions) (*autoscalingv1.HorizontalPodAutoscalerList, error)

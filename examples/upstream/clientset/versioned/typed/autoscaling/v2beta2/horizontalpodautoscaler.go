...
import (
	...
	autoscalingv2beta2client "k8s.io/client-go/kuberentes/typed/autoscaling/v2beta2"
...
type HorizontalPodAutoscalerClusterInterface interface {
	Cluster(logicalcluster.Path) autoscalingv2beta2client.HorizontalPodAutoscalerInterface

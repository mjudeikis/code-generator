...
type StatefulSetClusterInterface interface {
	Cluster(logicalcluster.Path) appsv1client.StatefulSetInterface

	List(ctx context.Context, opts v1.ListOptions) (*appsv1.StatefulSetList, error)
...
func (c *statefulSets) ApplyScale(ctx context.Context, statefulSetName string, scale *applyconfigurationautoscalingv1.ScaleApplyConfiguration, opts v1.ApplyOptions) (result *autoscalingv1.Scale, err error) {
	if scale == nil {

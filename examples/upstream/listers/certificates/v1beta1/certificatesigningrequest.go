...
func (s *certificateSigningRequestLister) List(selector labels.Selector) (ret []*v1beta1.CertificateSigningRequest, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*v1beta1.CertificateSigningRequest))
	})
	return ret, err
}

// List lists all CertificateSigningRequests in the indexer.
func (s *certificateSigningRequestClusterLister) List(selector labels.Selector) (ret []*v1beta1.CertificateSigningRequest, err error) {

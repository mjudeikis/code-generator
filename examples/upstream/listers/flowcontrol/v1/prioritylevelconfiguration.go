...
func (s *priorityLevelConfigurationLister) List(selector labels.Selector) (ret []*v1.PriorityLevelConfiguration, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*v1.PriorityLevelConfiguration))
	})
	return ret, err
}

// List lists all PriorityLevelConfigurations in the indexer.
func (s *priorityLevelConfigurationClusterLister) List(selector labels.Selector) (ret []*v1.PriorityLevelConfiguration, err error) {

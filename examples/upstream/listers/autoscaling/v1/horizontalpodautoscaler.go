...
func (s *horizontalPodAutoscalerLister) List(selector labels.Selector) (ret []*v1.HorizontalPodAutoscaler, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*v1.HorizontalPodAutoscaler))
	})
	return ret, err
}

// List lists all HorizontalPodAutoscalers in the indexer.
func (s *horizontalPodAutoscalerClusterLister) List(selector labels.Selector) (ret []*v1.HorizontalPodAutoscaler, err error) {

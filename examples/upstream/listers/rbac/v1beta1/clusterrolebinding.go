...
func (s *clusterRoleBindingLister) List(selector labels.Selector) (ret []*v1beta1.ClusterRoleBinding, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*v1beta1.ClusterRoleBinding))
	})
	return ret, err
}

// List lists all ClusterRoleBindings in the indexer.
func (s *clusterRoleBindingClusterLister) List(selector labels.Selector) (ret []*v1beta1.ClusterRoleBinding, err error) {

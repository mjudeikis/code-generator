...
func (s *controllerRevisionLister) List(selector labels.Selector) (ret []*v1beta1.ControllerRevision, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*v1beta1.ControllerRevision))
	})
	return ret, err
}

// List lists all ControllerRevisions in the indexer.
func (s *controllerRevisionClusterLister) List(selector labels.Selector) (ret []*v1beta1.ControllerRevision, err error) {

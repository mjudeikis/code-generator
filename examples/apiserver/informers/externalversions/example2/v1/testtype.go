...
import (
	...
	upstreamsecondexamplev1informers "k8s.io/client-go/informers/secondexample/v1"
	...
	v1 "k8s.io/code-generator/examples/apiserver/listers/example2/v1"
)
...
type TestTypeClusterInformer interface {
	...
	Cluster(logicalcluster.Name) upstreamsecondexamplev1informers.TestTypeInformer
}

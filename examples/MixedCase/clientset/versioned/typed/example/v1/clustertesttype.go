...
type ClusterTestTypeClusterInterface interface {
	Cluster(logicalcluster.Path) examplev1client.ClusterTestTypeInterface
...
func (c *clusterTestTypes) CreateScale(ctx context.Context, clusterTestTypeName string, scale *autoscalingv1.Scale, opts v1.CreateOptions) (result *autoscalingv1.Scale, err error) {
	result = &autoscalingv1.Scale{}

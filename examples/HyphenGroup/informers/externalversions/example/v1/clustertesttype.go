...
import (
	...
	upstreamexamplegroupv1informers "k8s.io/client-go/informers/examplegroup/v1"
...
type ClusterTestTypeClusterInformer interface {
	...
	Cluster(logicalcluster.Name) upstreamexamplegroupv1informers.ClusterTestTypeInformer
}
